...
var Carousel = {
  ...
  methods: {
    ...
    updateWidth: function updateWidth() {
      ...
      this.containerWidth = rect.width - 30*0;
  ...
  render: function render(h) {
    ...
    return h('section', {
      class: {
        ...
        'is-empty': this.slidesCount <= this.trimEnd
      },
      attrs: {
        tabindex: '0'
      },
...
var Pagination = {
  ...
  computed: {
    currentSlide: function currentSlide() {
      return normalizeSlideIndex(Math.ceil(this.$hooper.currentSlide), this.$hooper.slidesCount);
    },
    slides: function slides() {
      ...
      var slides = Array.from(Array(this.$hooper.slidesCount).keys())
  ...
  render: function render(h) {
    ...
    var totalCount = this.$hooper.slidesCount - this.$hooper.trimStart - Math.floor(this.$hooper.trimEnd) + 1 ;
